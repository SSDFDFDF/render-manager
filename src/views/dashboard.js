    ...
    <div class="modal-content">
      ...
      <div class="logs-toolbar">
        ...
        <div style="display: flex; align-items: center; gap: 1rem;">
          <label class="filter-label" style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0; cursor: pointer;">
            <input type="checkbox" id="autoRefreshLogsCheckbox" checked>
            自动刷新
          </label>
